...
def ler_numeros_processos(arquivo_csv="tjal/data/notebook1/numeros_processos.csv"):
...
async def baixar_pdf_processo(page, numero_processo, browser, max_retries=3):
    ...
    filename = f"tjal/data/notebook1/decisoes/{numero_processo}.pdf"
    ...
    try:
        ...
        for tentativa in range(max_retries):
            try:
                await page.goto("https://www2.tjal.jus.br/cpopg/open.do", wait_until="domcontentloaded", timeout=30000)
        ...
        # CORREÇÃO: Usar o domínio www2.tjal.jus.br em vez de esaj.tjal.jus.br
        # O link é relativo e deve ser resolvido no contexto do domínio não-bloqueado
        url_completa = "https://www2.tjal.jus.br" + url_relativa
        ...
        # CORREÇÃO: Usar www2.tjal.jus.br para download do PDF também
        pdf_url = "https://www2.tjal.jus.br" + pdf_path
        
        # Baixar PDF
        os.makedirs("tjal/data/notebook1/decisoes", exist_ok=True)
