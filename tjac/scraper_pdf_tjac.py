"""
Scraper para baixar PDFs das sentenças dos processos do TJAC
...
def ler_numeros_processos(arquivo_csv="tjac/data/notebook1/numeros_processos.csv"):
...
async def baixar_pdf_processo(page, numero_processo, browser):
    ...
    try:
        ...
        await page.goto("https://esaj.tjac.jus.br/cpopg/open.do", wait_until="domcontentloaded")
        ...
        url_completa = "https://esaj.tjac.jus.br" + url_relativa
        ...
        pdf_url = "https://esaj.tjac.jus.br" + pdf_path
        
        # Baixar PDF
        os.makedirs("tjac/data/notebook1/decisoes", exist_ok=True)
        context = browser.contexts[0]
        response = await context.request.get(pdf_url)
        
        if response.ok:
            pdf_bytes = await response.body()
            filename = f"tjac/data/notebook1/decisoes/{numero_processo}.pdf"
...
async def executar_scraping():
    ...
    print("=" * 60)
    print("SCRAPER TJAC - Download de PDFs das Sentenças")
    print("=" * 60)
