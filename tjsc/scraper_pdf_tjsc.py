...
def ler_numeros_processos(arquivo_csv="tjsc/data/notebook1/numeros_processos.csv"):
...
async def baixar_pdf_processo(page, numero_processo, browser):
    ...
    try:
        ...
        await page.goto("https://esaj.tjsc.jus.br/cpopg/open.do", wait_until="domcontentloaded")
        ...
        url_completa = "https://esaj.tjsc.jus.br" + url_relativa
        ...
        pdf_url = "https://esaj.tjsc.jus.br" + pdf_path
        
        # Baixar PDF
        os.makedirs("tjsc/data/notebook1/decisoes", exist_ok=True)
        context = browser.contexts[0]
        response = await context.request.get(pdf_url)
        
        if response.ok:
            pdf_bytes = await response.body()
            filename = f"tjsc/data/notebook1/decisoes/{numero_processo}.pdf"
