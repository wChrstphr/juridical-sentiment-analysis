...
def ler_numeros_processos(arquivo_csv="tjsp/data/notebook1/numeros_processos.csv"):
...
async def baixar_pdf_processo(page, numero_processo, browser):
    ...
    try:
        ...
        await page.goto("https://esaj.tjsp.jus.br/cpopg/open.do", wait_until="domcontentloaded")
        ...
        url_completa = "https://esaj.tjsp.jus.br" + url_relativa
        ...
        pdf_url = "https://esaj.tjsp.jus.br" + pdf_path
        
        # Baixar PDF
        os.makedirs("tjsp/data/notebook1/decisoes", exist_ok=True)
        context = browser.contexts[0]
        response = await context.request.get(pdf_url)
        
        if response.ok:
            pdf_bytes = await response.body()
            filename = f"tjsp/data/notebook1/decisoes/{numero_processo}.pdf"
